...
#                 st.image(img_data.url, caption="Generated Image")
#                 # Download button for the image
#                 image_response = requests.get(img_data.url)
#                 if image_response.status_code == 200:
#                     st.download_button("Download Image", image_response.content, file_name="generated_image.png")
#                 else:
...
#             for img_data in response.data:
#                 display_image_with_download(img_data.url)
        
#         except Exception as e:
#             st.error(f"Error: {e}")
#             logger.error(f"Image generation error: {e}")

# def display_image_with_download(img_url):
